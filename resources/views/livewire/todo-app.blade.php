<div class="w-full max-w-md mx-auto mt-10 bg-white rounded shadow-lg">
    <div class="w-full text-center p-5 m-2 rounded">
        <h1 class="text-green-900 font-bold text-3xl">Tasks</h1>
    </div>
        ...
        @else
            <ul>
                @foreach($tasks as $task)
                    <li wire:key={{$task->id}} class="border-b border-gray-200 py-2 flex justify-between items-center">
                        <div>
